 ...
 */
package com.outsystems.samskipnow.adapters;
...
public class ApplicationsAdapter extends ArrayAdapter<Application> {
    ...
    public ApplicationsAdapter(Context context, List<Application> applications) {
        super(context, com.outsystems.samskipnow.R.layout.applications_grid_item, applications);
        this.context = context;
        this.dataArray = applications;

        // Setting Options to lib Download Images
        options = new DisplayImageOptions.Builder().showImageOnLoading(com.outsystems.samskipnow.R.drawable.no_app_image)
                .showImageForEmptyUri(com.outsystems.samskipnow.R.drawable.no_app_image).showImageOnFail(com.outsystems.samskipnow.R.drawable.no_app_image)
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = inflater.inflate(com.outsystems.samskipnow.R.layout.applications_grid_item, null);

            // configure view holder
            viewHolder = new ViewHolder();
            viewHolder.textViewApplication = (TextView) rowView.findViewById(com.outsystems.samskipnow.R.id.text_view_application);
            viewHolder.textViewDescription = (TextView) rowView.findViewById(com.outsystems.samskipnow.R.id.text_view_description);
            viewHolder.imageViewApplication = (ImageView) rowView.findViewById(com.outsystems.samskipnow.R.id.image_view_application);
